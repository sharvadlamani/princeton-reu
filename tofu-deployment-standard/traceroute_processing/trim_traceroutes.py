...
input_dir = os.path.expanduser("~/reu/tofu-deployment-standard/cleaned_traceroutes")
output_dir = os.path.expanduser("~/reu/tofu-deployment-standard/trimmed_traceroutes")
